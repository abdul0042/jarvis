...
function AppContent() {
  ...
  useWakeWord({
    ...
    modalActive: jarvisAwake, // pause wake-word listener while already awake
    onWake: (text) => {
  ...
  const handleGlobalWakeUp = (triggerText = '') => {
    ...
    const greetingText = language === 'tanglish'
      ? `Hello ${userSalutation}! JARVIS active-ah iruken. Enna pannanum?`
      : `Hello ${userSalutation}! JARVIS is active. How can I help you?`;
